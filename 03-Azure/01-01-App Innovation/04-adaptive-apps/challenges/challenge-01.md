...
Challenge 02 needs one for Azure Bastion:
...
consistent Linux toolchain for Challenges 01-05. A manual host installation remains
supported.
...
> [!IMPORTANT]
> The configuration does not mount the host Docker socket. Challenge 05 supports
...
not reuse the Azure CLI token as a workspace: Challenge 03 creates separate Radius
...
No cluster connection is required yet. Challenge 02 creates the default platforms.
