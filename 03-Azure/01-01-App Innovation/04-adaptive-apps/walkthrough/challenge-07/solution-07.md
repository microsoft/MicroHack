...
The authoritative Challenge 07 pattern is:
...
The `core` portfolio from Challenge 04 already deployed `core-keycloak` in namespace
...
Challenge 07 extends `iac/app.bicep` once with optional parameters:
...
Challenge 06 behavior. Enabling them adds these frontend variables without introducing
...
`core-keycloak-admin` is managed by Helm. Re-running the Challenge 04
