...
Challenge 08 owns service-mesh authorization and OPA policy. Do not add its governance
resources here. Challenge 09 focuses on model selection, recipes, workload identity,
...
The `Radius.Resources/aiModels` type is part of the Challenge 04 catalog. Recreate its
...
This identity is for the application pod. It is separate from the Challenge 03 Radius
...
container name. Challenge 09 does not redeploy `iac/app.bicep`, so Challenge 07's
