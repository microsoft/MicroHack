...
.EXAMPLE
    .\1-resource-groups.ps1 -ResourceGroupPattern "SovereignCloud*"
    Deletes all resource groups starting with "SovereignCloud" across all subscriptions

.EXAMPLE
    .\1-resource-groups.ps1 -ResourceGroupPattern "rg-microhack-*"
    Deletes all resource groups matching "rg-microhack-*" across all subscriptions
