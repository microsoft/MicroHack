$pathToRepo = "https://raw.githubusercontent.com/microsoft/MicroHack/cth-updateDemoPage-MM/03-Azure/01-03-Infrastructure/06_Migration_Datacenter_Modernization/resources/demopage"
