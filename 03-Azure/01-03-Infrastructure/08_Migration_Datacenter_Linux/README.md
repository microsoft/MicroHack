...
This MicroHack scenario walks through the process how to migrate Linux VMs. The assessment, the tooling and processes are global best practices and with a focus on the real world scenarios, cost optimization and the best customer recommended design principles. Specifically, this builds up to include working with an existing infrastructure.

This work is based on:
- [MS MicroHack github ](https://github.com/microsoft/MicroHack/tree/main/03-Azure/01-03-Infrastructure/06_Migration_Datacenter_Modernization)
...
- Deploy the [Bicep configuration](./resources) of the Micro Hack to the Azure Region Germany West Central.
...
- [Get started with Azure Cloud Shell](https://learn.microsoft.com/en-us/azure/cloud-shell/get-started?tabs=azurecli#registering-your-subscription-with-azure-cloud-shell)
...
> [!IMPORTANT]
> Carefully select the appropriate OS for the Azure Migrate Appliance. The appliance should run on server with Windows Server 2019 or Windows Server 2022
...
- On-premises vs Azure total cost of ownership.
- Year on year cashflow analysis.
- Resource utilization based insights to identdeify servers and workloads that are ideal for cloud.
- Quick wins for migration and modernization including end of support Windows OS and SQL versions.
- Long term cost savings by moving from a capital expenditure model to an Operating expenditure model, by paying for only what you use.
...
* [How does Azure Migrate calculate the business case](https://learn.microsoft.com/en-us/azure/migrate/concepts-business-case-calculation)
...
* [RHEL Golden Image and BYOL](https://learn.microsoft.com/en-us/azure/virtual-machines/workloads/redhat/overview#red-hat-gold-images)
...
* Christian Pino Tossi [GitHub](https://github.com/cpinotossi)
