...
* **Choose a backlog item** — Pick a meaningful feature from `hackathon/backlog.md` (e.g. payment integration for the cart, order history, product search/filtering, or inventory management). A set of these may already be seeded as **GitHub Issues** in your repo — check the Issues tab and pick one.
