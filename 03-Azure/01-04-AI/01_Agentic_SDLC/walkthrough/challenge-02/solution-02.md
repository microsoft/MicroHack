# Walkthrough Challenge 2 - Deliver the cart feature
...
Complete [Challenge 1](../challenge-01/solution-01.md) — a working app and a responding Copilot — before starting.
...
- **Trying to build payment now** → payment is a follow-on (Challenge 3); capture it and stay scoped.
