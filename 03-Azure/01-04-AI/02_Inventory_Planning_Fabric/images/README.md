...
| `challenge-01-new-connection.png` | 1 | The **Add tool → Fabric Data Agent** connection dialog (Workspace ID / Artifact ID redacted) named `inventory-hack-agent` — created in Challenge 1. |
