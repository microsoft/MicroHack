# Challenge 0 — Get Grounded & Set Up
...
3. The **first** load seeds Cosmos from `src/data` (a few seconds), then the
   ...
   **Sense demand** button is already wired to the agent you build next; Steps 2–4
   ...
   would create and run your first hosted agent — that *is* Challenge 1, so you can
...
- Predict which locations Challenge 2 will flag CRITICAL before you get there.
