...
- Driven by [`src/proactive_alerts.py`](../src/proactive_alerts.py) (`--from-renewals --days 30`, `--dry-run`
  to preview); the alert text is generated by the **`gpt-5.4-nano`** Obligation & Renewal agent
  (`MODEL_RENEWAL`) — e.g. a **CT-4821 renewal-approaching** notice.
