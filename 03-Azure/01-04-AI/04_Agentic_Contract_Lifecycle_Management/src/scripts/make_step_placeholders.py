...
SLOTS: list[tuple[str, str, str, str]] = [
    ...
    ("challenge-0", "08-foundry-deployments", "Foundry Portal · Model deployments",
     "Foundry portal → Models + endpoints showing gpt-5.4, gpt-5.6-sol, gpt-5-mini and claude-opus-4-8 as 'Succeeded'."),
    ...
    ("challenge-0", "10-smoke-pass", "Terminal · Smoke test PASS",
     "The 'Smoke test: PASS' output with gpt, gpt-5.6-sol and claude replying OK."),
