...
SLOTS: list[tuple[str, str, str, str]] = [
    ...
    ("challenge-0", "08-foundry-deployments", "Foundry Portal · Model deployments",
     "Foundry portal → Models + endpoints showing gpt-5.4, gpt-5.6-sol and gpt-5.4-nano as 'Succeeded'."),
    ...
    ("challenge-0", "10-smoke-pass", "Terminal · Smoke test PASS",
     "The 'Smoke test: PASS' output with gpt-5.4, gpt-5.6-sol and gpt-5.4-nano replying OK."),
