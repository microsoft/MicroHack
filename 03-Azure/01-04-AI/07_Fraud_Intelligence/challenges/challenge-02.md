...
You have built an Evidence Enrichment Agent that retrieves traceable financial evidence from Azure Cosmos DB through a read-only MCP. Continue to [Challenge 3](challenge-03.md), where the enriched transaction will be assessed against global and regional regulations.
