# Solution 1 - Prepare the Environment
...
You have verified the Azure resources and opened the configured development environment. Continue to [Challenge 2](solution-02.md) to build the Evidence Enrichment Agent.