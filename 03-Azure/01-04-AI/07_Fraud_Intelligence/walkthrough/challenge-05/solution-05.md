...
As in [Challenge 4](solution-04.md), update the orchestration to include and connect the new agent.
...
For the complete **Foundry Toolkit** deployment procedure, refer to [Challenge 4](solution-04.md). For this deployment:
