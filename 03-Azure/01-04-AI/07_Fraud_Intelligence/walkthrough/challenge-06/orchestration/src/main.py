...
from business_metrics import alert_metrics_executor, evidence_metrics_executor, regulatory_metrics_executor
...
def main():
    ...
    alert_manager_executor = AgentExecutor(alert_manager_agent, context_mode="last_agent")
    ...
    workflow_agent = (
        ...
        .add_edge(evidence_enrichment_executor, evidence_metrics_executor)
        .add_edge(evidence_metrics_executor, regulatory_assessment_executor)
        .add_edge(regulatory_assessment_executor, regulatory_metrics_executor)
        .add_edge(regulatory_metrics_executor, aml_report_executor)
        .add_edge(regulatory_metrics_executor, alert_manager_executor)
        .add_edge(alert_manager_executor, alert_metrics_executor)
        .build()
        .as_agent()
    )
